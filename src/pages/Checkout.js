      ...
      <div className='flex flex-col lg:flex-row justify-between items-center md:items-start pt-10 sm:pt-12 pb-16 sm:pb-20 lg:pb-24 px-2'>
        <div className='lg:w-2/3 lg:pr-16 xl:pr-20'>
          <div>
            ...
            <p className='text-sm text-gray-500'>To purchase product(s) must fill in the data fields <br /> Please fill them carefully. Thank you</p>
          </div>

          <div className='pt-8 pb-10'>
            <h4 className='font-medium text-xl md:text-2xl text-center sm:text-left'>Billing Details</h4>
            <div className='pt-4 md:pt-5'>
              <form>
                <div className='flex justify-between'>
                  <input type='text' placeholder='First Name' className='mb-4 sm:mb-5 mr-2 w-full border border-gray-300 rounded px-6 py-3' />
                  <input type='text' placeholder='Last Name' className='mb-4 sm:mb-5 w-full border border-gray-300 rounded px-6 py-3' />
                </div>

                <div className='flex justify-between'>
                  <input type='email' placeholder='E-mail address' className='mb-4 sm:mb-5 mr-2 w-full border border-gray-300 rounded px-6 py-3' />
                  <input type='text' placeholder='Phone Number' className='mb-4 sm:mb-5 w-full border border-gray-300 rounded px-6 py-3' />
                </div>

                <input type='text' placeholder='Address' className='mb-4 sm:mb-5 mr-2 w-full border border-gray-300 rounded px-6 py-3' />

                <input type='text' placeholder='Apartmen, Suite, etc' className='mb-4 sm:mb-5 mr-2 w-full border border-gray-300 rounded px-6 py-3' />

                <input type='text' placeholder='City' className='mb-4 sm:mb-5 mr-2 w-full border border-gray-300 rounded px-6 py-3' />

                <div className='flex justify-between'>
                  <input type='email' placeholder='Country/Region' className='mb-4 sm:mb-5 mr-2 w-full border border-gray-300 rounded px-6 py-3' />
                  <input type='text' placeholder='Postcode or ZIP' className='mb-4 sm:mb-5 w-full border border-gray-300 rounded px-6 py-3' />
                </div>
              </form>
            </div>
            ...
            <div className='flex flex-col sm:flex-row justify-between items-center pt-8 sm:pt-8'>
              ...
              <button className='mr-4 inline-block border border-yellow-500 border-1 text-white bg-yellow-500 px-7 py-3 rounded uppercase text-center font-semibold'>Pay $200</button>
            </div>
          </div>
        </div>
        ...
        <div className='sm:w-2/3 md:w-1/2 lg:w-1/3 bg-gray-100 mt-8 lg:mt-0 shadow-xs'>
          <div className='p-8'>
            <h3 className='text-2xl pb-3 text-center sm:text-left'>Your order</h3>

            <div className='mt-5 mb-8'>
              <div className='flex items-center mb-6 group'>
                <div className='w-20 h-20'>
                  <img src='/assets/images/backpack-03-1.png' alt='product' className='w-full h-full object-contain object-center' />
                </div>
                ...
                <div className='hidden group-hover:block cursor-pointer p-2 hover:bg-gray-200'><FaTrash /></div>
              </div>
            </div>
