  ...
  return (
    <div className="flex flex-col py-6 mt-4">
      <div className="mb-8 mx-auto text-center">
        ...
        <h2 className="font-medium text-xl">Истакнати нови производи</h2>
        <button
          to="/shop/чевли"
          className="border border-1 bg-gray-500 text-white mx-2 mt-2 inline-block rounded px-12 py-1 uppercase"
        >
          Купете веднаш
        </button>
      </div>
