...
function ProductCard() {
  return (
    <div className='bg-left sm:bg-right bg-contain border-2 shadow bg-no-repeat h-full' style={{ backgroundImage: 'url(/assets/images/products/NikeAirMonarchIV/image-1.png)' }}>
